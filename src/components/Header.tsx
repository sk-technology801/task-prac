...
const Header = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      // Show black background when scrolled more than 50px
  ...
  return (
    <>
      <div className="min-h-screen bg-transparent flex flex-col">
        {/* Header - Fixed with Transparent/Black Background */}
        <header 
        ...
        >
          <div className="max-w-7xl mx-auto flex justify-between items-center">
            ...
            <div className={`text-base font-bold italic ${isScrolled ? 'text-white' : 'text-white'}`}>
              Help
            </div>
          </div>
        </header>
        ...
        <main className="flex flex-col flex-1">
          ...
          <div 
            ...
            style={{
              backgroundImage: "url('https://i.pinimg.com/1200x/e3/cc/ed/e3ccedf25111c258e862058ee4354b70.jpg')",
              ...
              <div className="text-white text-center relative z-10">
                <h1 className="mb-2">
                  <span className="text-[#7ec2f0] lg:text-3xl text-lg tracking-wide font-semibold italic">
                    ...
                    <span className="text-[#fcfdfd] lg:text-3xl text-lg tracking-wide font-semibold italic">
                      Write
                    </span>{' '}
                  </span>
                  <p className="text-[#fcfdfd] lg:text-3xl text-lg font-semibold italic my-1">
                    A Professional And Respectful Email To Your MP
                  </p>
                  <p className="text-[#e90dde] lg:text-3xl text-lg font-semibold italic my-1">
